...
#input data
gene_vs_patiensts_file = 'genes_vs_patients_indices_gen_paran.txt'      #基因及发生突变患者名单
gene_score_file = 'pan12gene2freq.txt'      #基因对应的突变频率
patient_data_file = 'patients_to_indices_gen.txt'        #患者名字和患者ID映射
gene_index_file = 'hint_index_file.txt'        #节点编号对应蛋白质映射
gene_edge_list_file = 'hint_edge_file.txt'     #蛋白质对应节点编号权重
